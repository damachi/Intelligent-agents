...
public class AuctionRandom implements AuctionBehavior {
  ...
  private int iterations_MAX = 10000;
	...
	public void auctionResult(Task previous, int winner, Long[] bids) {
		...
		if(mySolution != null) {
			long reward = myBids - mySolution.companyCost;
			System.out.println("Random agent Reward :"+reward);
		}
	...
	public Long askPrice(Task task) {
		...
		long low = myMarginalCost;
		long high = 2 * myMarginalCost;
		
		
		long myBid = ThreadLocalRandom.current().nextLong(low, high + 1);
